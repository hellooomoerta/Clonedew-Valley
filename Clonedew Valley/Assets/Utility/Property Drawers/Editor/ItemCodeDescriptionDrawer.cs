...
public class ItemCodeDescriptionDrawer : PropertyDrawer
{
    ...
    private string GetItemDescription(int itemCode)
    {
        ...
        so_itemList = AssetDatabase.LoadAssetAtPath("Assets/Scriptable Objects/Items/SO Item List.asset", typeof(SOItemList)) as SOItemList;

        List<ItemDetails> itemDetailsList = so_itemList.itemDetails;

        ItemDetails itemDetail = itemDetailsList.Find(x => x.itemNumber == itemCode);
